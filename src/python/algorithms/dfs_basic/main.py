...
# List nodes: contains the nodes we visit
nodes = []
...
# 2D list that will contain the characters of the map (our drawing)
charMap = [] 

# Map creation from csv file: fill the charMap list that we just created
...
# Finally add the proper identifiers to the start and goal point
